...
// 6 col x 8 rows (one page): area 1
...
// 6 col x 8 rows (one page): area 3, calc/prog/config mode
const PROGMEM uint8_t MiyoCalcFont_ProgMode[] =
{ 0x00, 0x7e, 0x12, 0x12, 0x1e, 0x00,  // programming mode
};

const PROGMEM uint8_t MiyoCalcFont_ConfigMode[] =
{ 0x00, 0x7e, 0x42, 0x42, 0x42, 0x00,  // config mode
};

// area 4, number base: block count = bits per digit (binary=1, octal=3, hex=4)
const PROGMEM uint8_t MiyoCalcFont_Binary[] =
{ 0x00, 0x00, 0x18, 0x18, 0x00, 0x00,  // binary mode
};

const PROGMEM uint8_t MiyoCalcFont_Octal[] =
{ 0x66, 0x66, 0x00, 0x00, 0x18, 0x18,  // octal mode
};

const PROGMEM uint8_t MiyoCalcFont_Hex[] =
{ 0x66, 0x66, 0x00, 0x00, 0x66, 0x66,  // hex mode
};

// area 5, user flags 0-7: each occupies a disjoint corner/edge position within the
// 6x8 cell, so any combination of active flags can be bitwise OR'ed together into a
// single composite glyph before sending to the LCD, without the marks overlapping
const PROGMEM uint8_t MiyoCalcFont_Flag0[] =
{ 0x00, 0x08, 0x0c, 0x00, 0x00, 0x00,
};

const PROGMEM uint8_t MiyoCalcFont_Flag1[] =
{ 0x00, 0x00, 0x00, 0x0c, 0x08, 0x00,
};

const PROGMEM uint8_t MiyoCalcFont_Flag2[] =
{ 0x00, 0x00, 0x00, 0x30, 0x10, 0x00,
};

const PROGMEM uint8_t MiyoCalcFont_Flag3[] =
{ 0x00, 0x10, 0x30, 0x00, 0x00, 0x00,
};

const PROGMEM uint8_t MiyoCalcFont_Flag4[] =
{ 0x06, 0x02, 0x00, 0x00, 0x00, 0x00,
};

const PROGMEM uint8_t MiyoCalcFont_Flag5[] =
{ 0x00, 0x00, 0x00, 0x00, 0x02, 0x06,
};

const PROGMEM uint8_t MiyoCalcFont_Flag6[] =
{ 0x00, 0x00, 0x00, 0x00, 0x40, 0x60,
};

const PROGMEM uint8_t MiyoCalcFont_Flag7[] =
